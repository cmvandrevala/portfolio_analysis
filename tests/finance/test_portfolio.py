...
class PortfolioTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.asset_data_1 = {"date": "2017-06-01", "name": "Proctor and Gamble", "symbol": "PG", "value": 1000, "asset_class": "Equities", "owner": "Bob"}
        self.asset_data_2 = {"date": "2017-07-01", "name": "Vanguard Bond Fund", "symbol": "VTIBX", "value": 2000, "asset_class": "Fixed Income", "owner": "Sam"}
    ...
    def test_it_imports_asset_data_for_an_existing_asset(self):
        asset_data = {"date": "2017-05-01", "name": "Verizon", "symbol": "VZ", "value": 5000, "asset_class": "class", "owner": "Abraham"}
        self.portfolio.import_data(asset_data)
        asset_data = {"date": "2017-05-02", "name": "Verizon", "symbol": "VZ", "value": 2000, "asset_class": "class", "owner": "Francis"}
        self.portfolio.import_data(asset_data)
        self.assertEqual(self.portfolio.percentages(), {"VZ": 1.0})

    def test_it_imports_asset_data_for_existing_and_new_assets(self):
        asset_data = {"date": "2017-06-01", "name": "VZ", "symbol": "VZ", "value": 3000, "asset_class": "class", "owner": "Willie"}
        self.portfolio.import_data(asset_data)
        asset_data = {"date": "2017-06-30", "name": "PEP", "symbol": "PEP", "value": 4000, "asset_class": "class", "owner": "Seymour"}
        self.portfolio.import_data(asset_data)
        asset_data = {"date": "2017-06-17", "name": "VZ", "symbol": "VZ", "value": 6000, "asset_class": "class", "owner": "Jack"}
        self.portfolio.import_data(asset_data)
        self.assertEqual(self.portfolio.percentages(), {"VZ": 0.6, "PEP": 0.4})

    def test_it_does_not_ignore_a_single_zero_dollar_amount(self):
        asset_data = {"date": "2012-01-01", "name": "T", "symbol": "T", "value": 0, "asset_class": "class", "owner": "Shauna"}
        self.portfolio.import_data(asset_data)
    ...
    def test_it_does_not_ignore_a_zero_dollar_amount_mixed_with_other_amounts(self):
        asset_data = {"date": "2011-02-08", "name": "Verizon", "symbol": "VZ", "value": 0, "asset_class": "class", "owner": "Brandine"}
        self.portfolio.import_data(asset_data)
        asset_data = {"date": "2011-02-08", "name": "Something", "symbol": "SP", "value": 12.54, "asset_class": "class", "owner": "Brittney"}
        self.portfolio.import_data(asset_data)
    ...
    def test_it_gives_the_total_value_of_the_portfolio_at_a_previous_time(self):
        asset_data = {"date": "2017-01-01", "name": "Verizon", "symbol": "VZ", "value": 100, "asset_class": "class", "owner": "Carl"}
        self.portfolio.import_data(asset_data)
        asset_data = {"date": "2017-06-01", "name": "SP", "symbol": "SP", "value": 12.50, "asset_class": "class", "owner": "Julie"}
        self.portfolio.import_data(asset_data)
    ...
    def test_it_combines_assets_with_the_same_symbol_in_percentage_calculations(self):
        asset_data = {"date": "2017-01-01", "name": "Foo", "symbol": "A", "value": 100, "asset_class": "class", "owner": "Felipe"}
        self.portfolio.import_data(asset_data)
        asset_data = {"date": "2017-06-01", "name": "Bar", "symbol": "A", "value": 100, "asset_class": "class", "owner": "Kent"}
        self.portfolio.import_data(asset_data)
        asset_data = {"date": "2017-02-01", "name": "Baz", "symbol": "B", "value": 100, "asset_class": "class", "owner": "Marge"}
        self.portfolio.import_data(asset_data)
    ...
    def test_it_creates_different_assets_given_different_symbols_with_the_same_name(self):
        asset_data = {"date": "2017-01-01", "name": "Foo", "symbol": "A", "value": 100, "asset_class": "class", "owner": "Lucy"}
        self.portfolio.import_data(asset_data)
        asset_data = {"date": "2017-06-01", "name": "Foo", "symbol": "B", "value": 200, "asset_class": "class", "owner": "Greg"}
        self.portfolio.import_data(asset_data)
    ...
    def test_it_returns_asset_data_for_one_cash_equivalent(self):
        asset_data = {"date": "2017-01-01", "name": "Foo", "symbol": "A", "value": 100, "asset_class": "Cash Equivalents", "owner": "Frank"}
        self.portfolio.import_data(asset_data)
    ...
    def test_it_returns_asset_data_for_one_real_estate_asset(self):
        asset_data = {"date": "2017-01-01", "name": "Foo", "symbol": "A", "value": 100, "asset_class": "Real Estate", "owner": "Anna"}
        self.portfolio.import_data(asset_data)
    ...
    def test_it_returns_asset_data_for_one_commodity(self):
        asset_data = {"date": "2017-01-01", "name": "Foo", "symbol": "A", "value": 100, "asset_class": "Commodities", "owner": "Clark"}
        self.portfolio.import_data(asset_data)
    ...
    def test_it_returns_asset_data_for_two_asset_classes(self):
        asset_data = {"date": "2017-01-01", "name": "Foo", "symbol": "A", "value": 100, "asset_class": "Equities", "owner": "Tiffany"}
        self.portfolio.import_data(asset_data)
        asset_data = {"date": "2017-02-01", "name": "Bar", "symbol": "B", "value": 100, "asset_class": "Fixed Income", "owner": "Eusavio"}
        self.portfolio.import_data(asset_data)
